...
namespace BarangayManagementSystem.Forms.User
{
    public partial class UserProfileForm : Form
    {
        ...
        public UserProfileForm(Models.User user)
        {
            currentUser = user;
            InitializeComponent();
        }
        ...
        private void LoadProfileData()
        {
            ...
            lblContactValue.Text = currentUser.ContactNumber ?? "Not provided";
            lblAddressValue.Text = currentUser.Address ?? "Not provided";
            lblMemberSinceValue.Text = currentUser.CreatedDate.ToString("MMMM dd, yyyy");
        }
        ...
        {
            MessageBox.Show("Edit Profile functionality will be implemented soon.", 
